...
// Remove and Hide - Cachet et supprimer un item de JEI
...
mods.jei.JEI.addItem(<minecraft:stone>.withTag({display:{Name: "Petit poucet",Lore:["Je suis une pierre", "Je ne m'appel pas Pierre"]}}));
